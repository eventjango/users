...
<div id="wrap">
	...
	<div class="contents">
		...
		<div class="main_cont_L">
			...
			<div class="center_cont">
				...
				<p class="withdraw_p">리플 (XRP) 출금</p>	
				<table class="withdraw_tb">
					...
					<tr>
						<td>출금 가능액</td>
						<td class="td1" id="balanceXRP"></td>
					</tr>
					<tr>
						<td>1일 출금 한도</td>
						<td class="td1">70.0005 XRP (횟수제한없음)</td>
					</tr>
					<tr>
						<td>1일 잔여 한도</td>
						<td class="td1">2000 XRP 현재 회원님은 인증 Level 4 단계입니다. &nbsp;<span>추가인증 받기</span></td>
					</tr>
					<tr>
						<td>리플 출금 주소</td>
						<td class="td1"><input type="text">&nbsp;<span>XRP 주소록</span></td>
					</tr>
					<tr>
						<td>출금신청 금액</td>
						<td class="td1">
								...
								XRP&nbsp;= <input type="text" class="in1"> KRW <span id="maximum">최대</span> <span class="gray">다시입력</span>
						</td>
					</tr>
					<tr>
						<td>비트코인 출금 수수료</td>
						<td class="td1">0.0005 XRP</td>
					</tr>
					<tr>
						<td>실제 출금 총액</td>
						<td class="td1">0 XRP</td>
					</tr>
					<tr>
						<td>SMS인증번호</td>
				...
				<p class="coin_btn">리플 (XRP) 출금요청</p>

				<div class="coin_text2">
					<span>리플 (XRP) 출금시 주의사항</span>
					<div>
					* 리플 (XRP) 지갑 주소를 반드시 확인하고 전달해 주세요.<br>
	...
	var balanceCoin = $.number('${balanceXRP}');
	$("#balanceXRP").append(balanceCoin+"XRP");
	$(".gray").click(function(){
	...
	$(".coin_btn").click(function(){
			balance.money("${login.id}","XRP",$("#wantwithdrawmoney").val().replace(/,/gi,""));
	});
	function comma(ds){
