...
//전역변수 사용안함.
    ...
    //action
    public void GmailSet(String id,String pw,String user, String text, String content){
        Properties p = System.getProperties();
        p.put("mail.smtp.starttls.enable", "true");    
        p.put("mail.smtp.host", "smtp.gmail.com");      // smtp 서버 호스트
        p.put("mail.smtp.auth","true");
        p.put("mail.smtp.port", "587");                 // gmail 포트 465, 587
            
        GoogleSMTP auth = new GoogleSMTP(id,pw);    //구글 계정 인증
          
        //session 생성 및  MimeMessage생성
        Session session = Session.getDefaultInstance(p, auth);
        MimeMessage msg = new MimeMessage(session);
        String fromName = "BITthrone";
        ...
        try{
            ...
            from = new InternetAddress(new String(fromName.getBytes(charSet), "8859_1") + "<"+id+">");
            msg.setFrom(from);
            ...
            //JOptionPane.showMessageDialog(null, "메일 주소를 입력해주세요", "메일주소입력", JOptionPane.ERROR_MESSAGE);
	...
	/*public static void main(String[] args) throws Exception{
    	...
    	gs.GmailSet("발신인 id","발신인 pw","수신인 id", "발신 메일 제목","발신 메일 내용");
	}*/
}