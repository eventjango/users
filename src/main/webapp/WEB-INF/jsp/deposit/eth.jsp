	...
	<div class="contents">
		...
		<div class="main_cont_L">
			...
			<div class="center_cont">
				...
				<p class="cointitle_big">이더리움(ETH)</p>

				<div class="coin_text">
					* 아래 주소로 이더리움(ETH) 을 입금해주세요.<br>
					* 신규가입하신 회원님께서는 주소 생성하기 버튼을 클릭하셔야 고유 이더리움(ETH) 주소가 발급됩니다.<br>
				</div>

				<p class="coin_btn">이더리움(ETH) 주소 생성 하기</p>

				<!-- 주소와 qr코드 박스 / 위에 버튼을 누르면 이 박스가 나타나게 하면 될듯합니다. -->
				<div class="deposit">
					<p class="p1">회원님의 이더리움(ETH) 입금 주소 :</p>
					<p class="p2">0S7GD0G809DS8790G70DG6GS0S0</p>
					<p class="p3"><img src="/images/qr.png"></p>
				</div><!-- 주소와 qr코드 끝-->

				<div class="coin_text">
					* 회원님께 할당된 위 이더리움(ETH) 주소로 이더리움(ETH)을 전송하시면 회원님의 전자지갑에 반영됩니다.<br>
					* 반영 시점 : 입금거래 후 10~30분 이후 자동으로 반영됩니다.<br>
				</div>

				<div class="coin_text2">
					<span>이더리움(ETH) 입금시 주의사항</span>
					<div>
					* 주의사항 텍스트가 들어갈 공간<br>
					* 주의사항 텍스트가 들어갈 공간<br>
					* 주의사항 텍스트가 들어갈 공간<br>
